...
module Day1 =
    let private removeLetters str =
        str |> String.filter System.Char.IsDigit
    ...
    let private getCalibrationValue1 input =
        input |> removeLetters |> calibrationValue
    ...
    let private getCalibrationValue2 input =
        input |> getNumberLine |> calibrationValue

    let part2 input =
        input |> List.sumBy getCalibrationValue2
